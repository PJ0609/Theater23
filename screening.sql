...
-- 2023-12-14
insert into screen(mov_id, mov_name, theater, scn_type, scn_time, end_time, remaining_seats, resv_seat) values(6, '다크 나이트', 1, '2D', '2023-12-14 09:00', '2023-12-14 11:00', 235, 'B12, D14, I13, G12, G14');
insert into screen(mov_id, mov_name, theater, scn_type, scn_time, end_time, remaining_seats, resv_seat) values(4, '더 마블스', 1, 'IMAX', '2023-12-14 11:00', '2023-12-14 13:00', 232, 'F8, G12, G13, D12, H10, E10, E11, G8');
insert into screen(mov_id, mov_name, theater, scn_type, scn_time, end_time, remaining_seats, resv_seat) values(5, '여귀교-저주를 부르는 게임', 1, '2D', '2023-12-14 13:00', '2023-12-14 15:00', 235, 'B12, D14, I13, G12, G14');
insert into screen(mov_id, mov_name, theater, scn_type, scn_time, end_time, remaining_seats, resv_seat) values(9, '뉴 노멀', 1, 'IMAX', '2023-12-14 15:00', '2023-12-14 18:00', 232, 'F8, G12, G13, D12, H10, E10, E11, G8');
insert into screen(mov_id, mov_name, theater, scn_type, scn_time, end_time, remaining_seats, resv_seat) values(8, '그대들은 어떻게 살 것인가', 1, '2D', '2023-12-14 18:00', '2023-12-14 20:00', 232, 'F8, G12, G13, D12, H10, E10, E11, G8');
insert into screen(mov_id, mov_name, theater, scn_type, scn_time, end_time, remaining_seats, resv_seat) values(1, '라따뚜이', 2, '2D', '2023-12-14 09:00', '2023-12-14 11:00', 235, 'B12, D14, I13, G12, G14');
insert into screen(mov_id, mov_name, theater, scn_type, scn_time, end_time, remaining_seats, resv_seat) values(20, '플라워 킬링 문', 2, 'IMAX', '2023-12-14 11:00', '2023-12-14 13:00', 232, 'F8, G12, G13, D12, H10, E10, E11, G8');
...
insert into screen(mov_id, mov_name, theater, scn_type, scn_time, end_time, remaining_seats, resv_seat) values(2, '살인의 추억', 2, '2D', '2023-12-15 09:00', '2023-12-15 11:00', 235, 'B12, D14, I13, G12, G14');
insert into screen(mov_id, mov_name, theater, scn_type, scn_time, end_time, remaining_seats, resv_seat) values(9, '뉴 노멀', 2, 'IMAX', '2023-12-15 11:00', '2023-12-15 13:00', 232, 'F8, G12, G13, D12, H10, E10, E11, G8');
insert into screen(mov_id, mov_name, theater, scn_type, scn_time, end_time, remaining_seats, resv_seat) values(8, '그대들은 어떻게 살 것인가', 2, '2D', '2023-12-15 13:00', '2023-12-15 15:00', 235, 'B12, D14, I13, G12, G14');
insert into screen(mov_id, mov_name, theater, scn_type, scn_time, end_time, remaining_seats, resv_seat) values(10, '싱글 인 서울', 2, '2D', '2023-12-15 15:00', '2023-12-15 17:00', 232, 'F8, G12, G13, D12, H10, E10, E11, G8');
insert into screen(mov_id, mov_name, theater, scn_type, scn_time, end_time, remaining_seats, resv_seat) values(14, '더 마블스', 2, 'IMAX', '2023-12-15 18:00', '2023-12-15 20:00', 232, 'F8, G12, G13, D12, H10, E10, E11, G8');
-- 2023-12-16
